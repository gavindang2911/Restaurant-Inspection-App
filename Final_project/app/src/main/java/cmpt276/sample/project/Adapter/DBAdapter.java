...
public class DBAdapter {
    ...
    public static final String KEY_LATESTINSPECTION = "latestInspection";
    ...
    public long insertRow(String trackingNumber, String name, String address, int issue, String lastInspection, String hazardLevel) {
        /*
         * CHANGE 3:
         */
        ...
        initialValues.put(KEY_LATESTINSPECTION, lastInspection);
    ...
    public boolean updateRow(long rowId, String trackingNumber, String name, String address, int issue, String lastInspection, String hazardLevel) {
        String where = KEY_ROWID + "=" + rowId;
        ...
        newValues.put(KEY_ISSUE, issue);
        newValues.put(KEY_LATESTINSPECTION, lastInspection);
